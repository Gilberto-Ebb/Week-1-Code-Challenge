...
/*
    On salary input, it shows all deductions, paye tax and the net users salary.
    ...
    Total deductions = (payee + NHIF + NSSF)
    Net pay/salary = Gross pay - deductions e.g Gross salary - (payee + NHIF + NSSF) ==> net salary
    
*/

// enable accepting user input on the stdin
